...
function strip() {
  ...
  var halim_quote = fs.readFileSync('./quotes/halim.txt').toString('utf-8').split("\n");
  var qabbani_quote = fs.readFileSync('./quotes/qabbani.txt').toString('utf-8').split("\n");

  authors.push(rumi_quote, hafiz_quote, darwish_quote, ghazali_quote, pamuk_quote, gibran_quote, halim_quote, qabbani_quote);
